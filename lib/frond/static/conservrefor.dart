  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(child: ListView(
        children: [
          ImageContainerWidget(imagePath: 'assets/images/mono1.jpg', 
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text: context.tr('texts.conservrefor.restHabit.text.p1'), 
                    ),
                    TextSpan(
                      text: context.tr('texts.conservrefor.restHabit.text.negrita'),
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                    ...
                    TextSpan(
                      text: context.tr('texts.conservrefor.restHabit.text.p2'),
                    ),
                  ]
                ), 
              ),
        ...
        Container(
          margin: (!isMobil) ? EdgeInsets.all(50) : EdgeInsets.all(10),
                child: ResponsiveLayout(
                  ...
                  children: [
                    TextContainerWidget(
                      ...
                      alignment: Alignment.center,
                      style: TextStyle(
                        fontSize: (!isMobil) ? (anchoPantalla * 0.04).clamp(32.0,50.0) : 30,
                        fontWeight: FontWeight.bold,
                    ...
                    TextContainerWidget(
                      ...
                      alignment: Alignment.center,
                      style: TextStyle(
                        fontSize: (!isMobil) ? (anchoPantalla * 0.02).clamp(18.0,24.0) : 30,
                        fontWeight: FontWeight.w300,
                        color: const Color.fromARGB(255, 40, 60, 40),
                        fontFamily: 'Oswald',
                      ),
                    ),
                  ],
        ...
        Container(
          ...
          padding: (!isMobil) ? EdgeInsets.all(50) : EdgeInsets.all(10),
                child: ResponsiveLayout(
                  breakpoint: 900,
                  children: [
                    TextContainerWidget(
                      ...
                      style: TextStyle(
                        fontSize: (!isMobil) ? (anchoPantalla * 0.04).clamp(32.0,50.0) : 30,
                        fontWeight: FontWeight.bold,
                        color: const Color.fromARGB(255, 4, 88, 4),
                        fontFamily: 'Oswald',
                      ),
                    ),
                    TextContainerWidget(
