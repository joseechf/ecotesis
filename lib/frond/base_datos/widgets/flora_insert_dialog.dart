import 'package:ecoazuero/frond/base_datos/widgets/widget_form_insert.dart';
...
class EspecieDialogInsertEdit extends StatefulWidget {
  ...
  const EspecieDialogInsertEdit({super.key, this.especieInicial, required this.tieneInternet});
              ...
              child: Column(
                children: [
                  CampoTexto(
                    ...
                    validator: esEdicion ? null : ValidadorTexto.validaNoObligatorio,
                    readOnly: esEdicion,
                  ),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: InputDecoration(
                      labelText: context.tr('bdInterfaz.insert.formaCrecimiento'),
                      border: OutlineInputBorder(),
                    ),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: dropItemsTraducidos(context, ['Mariposa','Abeja','Mixto']),
                  ),
                  const SizedBox(height: Estilos.paddingMedio,),
                  DropdownButtonFormField<String>(
                    ...
                    items: dropItemsTraducidos(context, ['Seco','Humedo','Mixto']),
                  ),
                   const SizedBox(height: Estilos.paddingMedio,),
                  DropdownButtonFormField<String>(
                    ...
                    decoration: InputDecoration(
                      labelText: context.tr('bdInterfaz.insert.establecidoSolSombra'),
                      border: OutlineInputBorder(),
                    ),
                    items: dropItemsTraducidos(context, ['Sol','Sombra','Mixto']),
                  ),
                  const SizedBox(height: Estilos.paddingMedio,),
                  CampoTexto(
                  ...
                  campoVectorGenerico<Origen>(
                    ...
                    getValor: (n) => n.origen, 
                    setValor: (n, v) => n.origen = v, 
                    crearVacio: () => Origen(origen: ''),
                    validator: ValidadorTexto.validaNoObligatorio,
                  ),
                  const SizedBox(height: Estilos.paddingMedio,),
                  if(widget.tieneInternet)
                  ...[
                      Text(
            ...
            ElevatedButton(
              ...
              child: 
                  provider.cargandoData
                      ...
                      ) : Text(esEdicion ? context.tr('buttons.update')  : context.tr('buttons.add'),),
            ),
          ],
        );
      },
